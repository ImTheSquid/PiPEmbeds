...
var require_sister = __commonJS({
  "node_modules/sister/src/sister.js"(exports2, module2) {
    "use strict";
    var Sister;
    Sister = function() {
      var sister = {}, events = {};
...
var require_load_script = __commonJS({
  "node_modules/load-script/index.js"(exports2, module2) {
...
var require_loadYouTubeIframeApi = __commonJS({
  "node_modules/youtube-player/dist/loadYouTubeIframeApi.js"(exports2, module2) {
    "use strict";
...
var require_functionNames = __commonJS({
  "node_modules/youtube-player/dist/functionNames.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_eventNames = __commonJS({
  "node_modules/youtube-player/dist/eventNames.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_PlayerStates = __commonJS({
  "node_modules/youtube-player/dist/constants/PlayerStates.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_FunctionStateMap = __commonJS({
  "node_modules/youtube-player/dist/FunctionStateMap.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_YouTubePlayer = __commonJS({
  "node_modules/youtube-player/dist/YouTubePlayer.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_dist = __commonJS({
  "node_modules/youtube-player/dist/index.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_YouTube = __commonJS({
  "node_modules/react-youtube/dist/YouTube.js"(exports2, module2) {
    ...
    var _YouTube = class extends import_react.default.Component {
      constructor(props) {
        ...
        this.resetPlayer = () => {
          var _a;
          return (_a = this.internalPlayer) == null ? void 0 : _a.destroy().then(this.createPlayer);
        };
        this.updatePlayer = () => {
          var _a;
        ...
        this.updateVideo = () => {
          ...
          if (autoplay) {
            (_b = this.internalPlayer) == null ? void 0 : _b.loadVideoById(opts);
            return;
          }
          (_c = this.internalPlayer) == null ? void 0 : _c.cueVideoById(opts);
        };
      ...
      componentWillUnmount() {
        var _a;
        (_a = this.internalPlayer) == null ? void 0 : _a.destroy();
      }
      render() {
    ...
    var YouTube2 = _YouTube;
    YouTube2.propTypes = propTypes;
    YouTube2.defaultProps = defaultProps;
    YouTube2.PlayerState = {
      UNSTARTED: -1,
      ENDED: 0,
      PLAYING: 1,
      PAUSED: 2,
...
var import_react_youtube = __toESM(require_YouTube());
  ...
  function next(steps) {
    ...
    const idx = pipKeys.findIndex((key) => key === currentPiP);
  ...
  function EmbedCapturePrompt(props) {
    return /* @__PURE__ */ React.createElement("div", {
      ...
      style: { width: props.width ?? "400px", height: props.height ?? "225px" }
      ...
      style: { fontWeight: "bold", marginBottom: "10px", color: "var(--text-color)", textAlign: "center" }
  ...
  class EmbedFrameOverlay extends React.Component {
    ...
    componentDidMount() {
      if (this.state.showCapturePrompt && settings.autoCapture)
  ...
  class YouTubeFrame extends React.Component {
    ...
    componentDidMount() {
      if (this.state.canGrab && settings.autoCapture)
        this.grabPlayer();
    }
    componentWillUnmount() {
      Dispatcher.unsubscribe("PIP_EMBED_ID_UPDATE", this.onEmbedId);
    ...
    renderVideoPreview() {
      return /* @__PURE__ */ React.createElement("div", {
        ...
        renderLinkComponent: () => {
          /* @__PURE__ */ React.createElement("p", null, "LINK");
        },
  ...
  return class extends Plugin {
    onStart() {
      ...
      Patcher.after(Embed.default.prototype, "render", (that, args, ret) => {
        ...
        ret.props.children.props.children[6] = /* @__PURE__ */ React.createElement(YouTubeFrame, {
          ...
          data: { ref: new URL(that.props.embed.url).searchParams.get("v") }
        });
      });
      ...
      Patcher.instead(PictureInPictureContainer.prototype, "render", (that, _, original) => {
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, origin, /* @__PURE__ */ React.createElement(PiPWindowController, {
    ...
    getSettingsPanel() {
      ...
      return new SettingPanel(() => {
        PluginUtilities.saveSettings("PiPEmbeds", settings);
      }, new Switch("Auto-Capture", "Capture picture-in-picture media automatically when the parent message is loaded.", settings.autoCapture, (isOn) => settings.autoCapture = isOn), new Slider("Media Switch Scroll Distance", "How far to scroll over the picture-in-picture window before it switches to the next media source.", 1, 900, settings.scrollStep, (val) => settings.scrollStep = val, {
